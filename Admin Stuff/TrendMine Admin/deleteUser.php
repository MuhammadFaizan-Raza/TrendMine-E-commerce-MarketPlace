                    ...
                    <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <p class="breadcrumbs"><span><a href="index.html">Home</a></span>
                                <span><i class="mdi mdi-chevron-right"></i></span>User Registration</p>
                        </div>
                        <div>
                                    ...
                                    <div class="row ec-vendor-uploads">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="ec-vendor-upload-detail">
                                                <form class="row g-3"  method = "post" action = "deleteUserq.php">
                                                   
                                                    <div class="col-md-6">
                                                        <label for="userID" class="form-label">User ID</label>
                                                        <input list="userIDs" name="userID" id="userID" class="form-control">
                                                        <datalist id="userIDs">
                                                            <?php
                                                            session_start();
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="mobileOrEmail" class="form-label">Mobile Number or Email</label>
