                ...
                <div class="ec-cat-list card card-default mb-24px">
                  <div class="card-body">
                    <div class="ec-cat-form">
                      ...
                      <form method="post" action="deleteProductq.php">
                          ...
                          <div class="col-lg-6">
                            ...
                            <datalist id="categoryIDs">
                              <?php
                                                            ...
                                                            $sql = "SELECT Prod_Id FROM ProductInformation";
                        ...
                        <div class="form-group row">
                          <label for="taxPoints" class="col-lg-6 col-form-label"
